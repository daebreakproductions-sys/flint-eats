...
const SAMPLE_RESOURCES = [
  { id: "s1", title: "Understanding SNAP Benefits in Michigan", category: "Benefits & Programs", content_type: "Video", description: "Learn how to apply for SNAP/EBT benefits and what foods are covered.", duration_minutes: 8, is_featured: true, url: "https://www.michigan.gov/mdhhs/assistance-programs/foodassistance", thumbnail_url: "https://images.unsplash.com/photo-1542838132-92c53300491e?w=400&h=250&fit=crop" },
  { id: "s2", title: "Double Up Food Bucks: Stretch Your SNAP", category: "Benefits & Programs", content_type: "Article", description: "Find out how to double your SNAP dollars at farmers markets across Genesee County.", is_featured: true, url: "https://www.doubleupfoodbucks.org/" },
  { id: "s3", title: "Healthy Cooking on a Budget", category: "Cooking", content_type: "Video", description: "Simple, nutritious recipes using affordable and local ingredients.", duration_minutes: 15, thumbnail_url: "https://images.unsplash.com/photo-1466637574441-749b8f19452f?w=400&h=250&fit=crop" },
  { id: "s4", title: "WIC Program Guide for Families", category: "Benefits & Programs", content_type: "Guide", description: "Everything you need to know about WIC eligibility and benefits for mothers and children." },
  { id: "s5", title: "Safe Food Storage Tips", category: "Food Safety", content_type: "Article", description: "Keep your family safe by learning proper food handling and storage practices." },
  { id: "s6", title: "Growing Your Own Vegetables", category: "Nutrition", content_type: "Guide", description: "Community garden basics for beginners — grow fresh produce even in small spaces.", thumbnail_url: "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=400&h=250&fit=crop" },
];
