      ...
      <header className="bg-gradient-to-r from-green-700 to-emerald-800 shadow-md sticky top-0 z-50 hidden md:block">
        <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between gap-4">
          <Link to="/Feed" className="flex items-center gap-2 shrink-0 select-none">
            <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69b73bf820481df67e8a6ca5/51414b592_IMG_8997.jpg" alt="Flint Eats" className="h-8 w-8 object-contain" />
